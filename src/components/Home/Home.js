...
function Home() {
  return (
    <section>
      ...
      <Home2 />
      <RandomCard title1={"WHY"} title2={"CATS?"} 
          ...
          image={Cat}/>
      <RandomCard title1={"WHY"} title2={"PROGRAMMING?"} 
